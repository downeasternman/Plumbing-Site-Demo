  ...
  return (
    <div className="site-container py-16">
      ...
      <section className="mt-12 grid gap-6 md:grid-cols-2">
        <article className="rounded-xl border border-border bg-white p-6 shadow-sm">
          ...
          <p className="mt-3 text-sm leading-7 text-muted">
            Founded to serve homeowners across Washington County, our team grew
            from local referrals and repeat customers who value dependable
            workmanship. We understand the plumbing challenges Maine homes face,
            from winter freeze risks to aging piping systems.
          </p>
        </article>
        <article className="rounded-xl border border-border bg-white p-6 shadow-sm">
      ...
      <section className="mt-12 rounded-xl border border-border bg-white p-6 shadow-sm">
        ...
        <p className="mt-3 text-sm leading-7 text-muted">
          We hold every job to the same standard: safe repairs, code-compliant
          workmanship, and communication you can trust. We are proud to support
          communities in Machias, Calais, Eastport, Milbridge, and beyond.
        </p>
      </section>
      ...
      <section className="mt-12 rounded-2xl bg-primary p-8 text-white md:p-10">
        ...
        <p className="mt-3 max-w-2xl text-blue-100">
          Reach out for scheduling, emergency help, or a no-pressure conversation
          about your plumbing options.
        </p>
        <div className="mt-6 flex flex-col gap-3 sm:flex-row">
          <CTAButton href="/contact">Book Service</CTAButton>
